...
label ch2_main:
    ...
    "Damn it."
    "I've started to grow use to the absolute bull shittery that happens in that bleeding cock hole over the past couple days."
    "Thankfully, when I arrived I didn't have to witness any more disturbing imagery."
    show sayori 2x at t11 zorder 2
    s "Hi [player]~"
    mc "Kys, furfag."
    mc "Why are you always so fucking happy? Turn it down a bit, brainlet."
    s 1q "Ehehe~"
    s "I'm just still not used to you being in the club, that's all."
    mc "Me too. Every fucking minute I spend here degrades my physical being."
    mc "I should've just pushed you into the fucking road when you came running at me the other day."
    mc "My past self is a piece of fucking shit that you have to scrape off your dick after doing anal for the first time with your homosexual partner."
    mc "But of course you don't say anything because you love Jim and he means the mf world to you. A minor flaw in one sexual escapade is not cause"
    mc "To ruin a perfectly happy and healthy relation ship"
    s 1d "Speaking of which..."
    s "I'm kinda hungry..."
    s "Will you come with me to buy a snack?"
    mc "No, frick off you hecking fuck."
    s 4h "Eh??"
    ...
    s 5a "A-Ahaha..."
    mc "I knew it..."
    mc "I can see right through you, Dumb ass."
    s 5c "That's not fair!"
    s "How did you even know?"
    mc "It's simple."
    mc "If you had enough money in the first place, you'd eat something other than Hot Pockets and Little Debbie Cosmic Brownies."
    mc "So, you planned to conveniently forget that you spent all the money you stole from the salvation army worker in front of walmart on gay hentai and tickets for emojiland the musical."
    mc "and you'd act like a little cunt until I bought something for you."
    s 4p "Uwaaa~!"
    s "I give up!"
    s "Don't make me feel guiltyyy!"
    mc "If you feel guilty, that means you deserve to feel guilty you stupid dong strangler."
    show yuri 1c at t33 zorder 2
    y "Ahaha."
    "Yuri suddenly giggles."
    show sayori 4g
    mc "Eh?"
    "I didn't notice that she was a nosy little slut."
    "Her face is in her book, as always."
    "Damn that social anxiety is gonna destroy her emo ass once she graduates, lmao."
    show yuri 3n at h33
    y "A-Ah!"
    ...
    mc "I'm not gonna let you borrow shit you money hungry jew."
    ...
    mc "Wow Sayori, when did you become such a dog fucking cuck?"
    show sayori at t32 zorder 2
    show yuri at f33 zorder 3
    y 3v "That's..."
